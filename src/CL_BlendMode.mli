...
external get_blend_color : t -> CL_Colorf.t
  = "caml_CL_BlendMode_get_blend_color"
external get_blend_equation : t -> CL_BlendEquation.t
  = "caml_CL_BlendMode_get_blend_equation"
external get_blend_equation_alpha : t -> CL_BlendEquation.t
  = "caml_CL_BlendMode_get_blend_equation_alpha"
external get_blend_function_src : t -> CL_BlendFunc.t
  = "caml_CL_BlendMode_get_blend_function_src"
external get_blend_function_dest : t -> CL_BlendFunc.t
  = "caml_CL_BlendMode_get_blend_function_dest"
external get_blend_function_src_alpha : t -> CL_BlendFunc.t
  = "caml_CL_BlendMode_get_blend_function_src_alpha"
external get_blend_function_dest_alpha : t -> CL_BlendFunc.t
